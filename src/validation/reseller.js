...
const validate = {
  create: (request, response, next) => {
    request
      .assert('revendedor.cpf', 'CPF é obrigatório')
      .notEmpty()
      .trim();
    ...
    request
      .assert('revendedor.nome', 'Nome é obrigatório')
      .notEmpty()
      .trim();
    ...
    request
      .assert('revendedor.senha', 'Senha é obrigatória')
      .notEmpty()
      .trim();
  ...
  login: (request, response, next) => {
    request
      .assert('login.cpf', 'CPF é obrigatório')
      .notEmpty()
      .trim();
    ...
    request
      .assert('login.senha', 'Senha é obrigatória')
      .notEmpty()
      .trim();
